...
//节点链接 + 订阅链接
let MainData = `
vless://ccb7d3b0-ffbd-4c40-a100-4f4b70c2410b@104.18.127.130:443?encryption=none&security=tls&sni=cfjd-5d2.pages.dev&fp=chrome&type=ws&host=cfjd-5d2.pages.dev&path=%2F%3Fed%3D2048#%E8%81%94%E9%80%9A-443-WS-TLS
hysteria2://6b8e1ed5-0931-4677-ba5b-b2c43bf9fe7e@198.144.181.45:41072?sni=www.bing.com&alpn=h3&insecure=1#hy2-racknerd
hysteria2://775b2e65-0283-4e3f-a34f-f32ddb702e0c@104.168.77.74:30414?sni=www.bing.com&alpn=h3&insecure=1#hy2-ColoCrossing
	...
	async fetch(request, env) {
		...
		if (!([mytoken, fakeToken, 访客订阅].includes(token) || url.pathname == ("/" + mytoken) || url.pathname.includes("/" + mytoken + "?"))) {
			...
			if (订阅格式 == 'base64' || token == fakeToken) {
				...
				subConverterUrl = `${subProtocol}://${subConverter}/sub?target=quanx&url=${encodeURIComponent(订阅转换URL)}&insert=false&config=${encodeURIComponent(subConfig)}&emoji=true&list=false&tfo=false&scv=true&fdn=false&sort=true`;
			} else if (订阅格式 == 'loon') {
			...
			try {
				...
				// 修改点 2：增加针对 Clash 与 Sing-box 响应内容的修复逻辑
				if (订阅格式 == 'clash') {
					subConverterContent = await clashFix(subConverterContent);
				} else if (订阅格式 == 'singbox') {
					subConverterContent = singboxFix(subConverterContent);
				}
				...
				<body>
					...
					<div class="editor-container">
						...
						<textarea class="editor" 
							placeholder="${decodeURIComponent(atob(''))}"
					...
					<br>
					################################################################<br>
					${decodeURIComponent(atob('dGVsZWdyYW0lMjAlRTQlQkElQTQlRTYlQjUlODElRTclQkUlQTQlMjAlRTYlOEElODAlRTYlOUMlQUYlRTUlQTQlQTclRTQlQkQlQAC3~'))}
